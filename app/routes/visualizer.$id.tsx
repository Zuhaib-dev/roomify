...
export function meta({ params }: Route.MetaArgs) {
  ...
  return [
    { title: `Project ${projectId} - Roomify by Zuhaib Rashid` },
    {
      name: "description",
      content:
        "AI-generated architectural visualization created with Roomify. Transform 2D floor plans into photorealistic 3D renders.",
    },
    { name: "author", content: "Zuhaib Rashid" },

    // Open Graph
    { property: "og:type", content: "article" },
    { property: "og:title", content: `Architectural Project - Roomify` },
    {
